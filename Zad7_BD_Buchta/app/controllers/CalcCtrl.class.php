...
// 3. wykonaj zadanie jeśli wszystko w porządku
	...
	$this->form->procent = floatval($this->form->procent);
        $this->form->procent=round($this->form->procent,1);
            ...
            try {
                ...
                getDB()->insert("wyniki",[
                    ...
                    "ile_procent"=>$this->form->procent ,
                    "kwota_dlugu"=>$this->wynik->kwota_dlugu ,
                    "kwota_kredytu"=>$this->form->kwota ,
                    "wynik"=>$this->wynik->wynik,
                    "id_uzytkownika"=> $user->getid()
