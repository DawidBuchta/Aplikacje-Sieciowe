...
getRouter()->addRoute('HistoryList',      'HistoryCtrl', ['user','admin']);
getRouter()->addRoute('AddUserShow',      'AddUserCtrl', ['admin']);
getRouter()->addRoute('AddUser',      'AddUserCtrl', ['admin']);
getRouter()->addRoute('RemoveUser',      'RemoveUserCtrl', ['admin']);
